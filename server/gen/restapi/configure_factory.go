...
import (
	...
	"github.com/montblanc18/go-swagger-sample/server"
	"github.com/montblanc18/go-swagger-sample/server/gen/restapi/factory"
)

//go:generate swagger generate server --target ../../gen --name Factory --spec ../../../swagger.yml --api-package factory --principal interface{}
